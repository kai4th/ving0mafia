...
enum class IconMap(val res: Int) {
    TLX(R.drawable.tlx),
    네이버(R.drawable.naver_logo),
    차이의_놀이(R.drawable.havit),
    삼분의일(R.drawable.sam1),
    VINGLE(R.drawable.vingle),
    NHN_ENTER(R.drawable.nhn_enter),
    COUPANG(R.drawable.coupang),
    ...
    ST_UNITAS(R.drawable.st_unitas),
